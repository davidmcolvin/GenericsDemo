  ...
  internal static class GenericTextFileProcessor
  {
    public static List<T> LoadFromTextFile<T>(string filePath) where T : class, new()
    {
      ...
      foreach (var row in lines)
      {
        ...
        // of this row matches the index of the header to the
    ...
    internal static void SaveToTextFile<T>(List<T> data, string filePath) where T : class
    {
      ...
      {
        throw new ArgumentException("data", "You must populate the data parameter with at least one item");
      }
